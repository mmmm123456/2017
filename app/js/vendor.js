window.Modernizr = function(window, document, undefined) {
        ...
        function webforms() {
            Modernizr.input = function(props) {
                ...
                for (var bool, inputElemType, defaultView, i = 0, len = props.length; i < len; i++) inputElem.setAttribute("type", inputElemType = props[i]), bool = "text" !== inputElem.type, bool && (inputElem.value = smile, inputElem.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(inputElemType) && inputElem.style.WebkitAppearance !== undefined ? (docElement.appendChild(inputElem), defaultView = document.defaultView, bool = defaultView.getComputedStyle && "textfield" !== defaultView.getComputedStyle(inputElem, null).WebkitAppearance && 0 !== inputElem.offsetHeight, docElement.removeChild(inputElem)) : /^(search|tel)$/.test(inputElemType) || (bool = /^(url|email)$/.test(inputElemType) ? inputElem.checkValidity && inputElem.checkValidity() === !1 : inputElem.value != smile)), inputs[props[i]] = !!bool;
                return inputs
            }("search tel url email datetime date month week time datetime-local number range color".split(" "))
        }
        var featureName, hasOwnProp, version = "2.6.3",
            Modernizr = {},
            enableClasses = !0,
    ...
    function(window, undefined) {
        ...
        jQuery.fn = jQuery.prototype = {
            ...
            map: function(elems, callback, arg) {
                var value, i = 0,
                    ...
                    ret = [];
                if (isArray)
                    for (; i < length; i++) value = callback(elems[i], i, arg), null != value && (ret[ret.length] = value);
                else
        ...
        jQuery.ajaxSetup({
            ...
            if (jsonProp || "jsonp" === s.dataTypes[0]) return callbackName = s.jsonpCallback = jQuery.isFunction(s.jsonpCallback) ? s.jsonpCallback() : s.jsonpCallback, jsonProp ? s[jsonProp] = s[jsonProp].replace(rjsonp, "$1" + callbackName) : s.jsonp !== !1 && (s.url += (ajax_rquery.test(s.url) ? "&" : "?") + s.jsonp + "=" + callbackName), s.converters["script json"] = function() {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(Animation, SimpleTimeline, TweenLite) {
                ...
                return p.constructor = TimelineMax, p.kill()._gc = !1, TimelineMax.version = "1.19.0", p.invalidate = function() {
                    ...
                    this._onUpdate && (suppressEvents || (_lazyTweens.length && _lazyRender(), this._callback("onUpdate"))), callback && (this._locked || this._gc || prevStart !== this._startTime && prevTimeScale === this._timeScale || (0 === this._time || totalDur >= this.totalDuration()) && (isComplete && (_lazyTweens.length && _lazyRender(),
                        this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !suppressEvents && this.vars[callback] && this._callback(callback)))
            ...
            function() {
                ...
                var _getFormatter = function(dflt, clr, collapsible, multi) {
                    ...
                    _parseComplex = CSSPlugin.parseComplex = function(t, p, b, e, clrs, dflt, pt, pr, plugin, setRatio) {
                        ...
                        for (e.indexOf(",") === -1 && b.indexOf(",") === -1 || (ba = ba.join(" ").replace(_commasOutsideParenExp, ", ").split(" "), ea = ea.join(" ").replace(_commasOutsideParenExp, ", ").split(" "), l = ba.length), l !== ea.length && (ba = (dflt || "").split(" "), l = ba.length), pt.plugin = plugin, pt.setRatio = setRatio, _colorExp.lastIndex = 0, i = 0; i < l; i++)
                ...
                var _useSVGTransformAttr, _transformProps = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    _getTransform = _internals.getTransform = function(t, cs, rec, parse) {
                        ...
                        if (tm.svg = !(!t.getBBox || !_isSVG(t)), tm.svg && (_parseSVGOrigin(t, _getStyle(t, _transformOriginProp, cs, !1, "50% 50%") + "", tm, t.getAttribute("data-svg-origin")), _useSVGTransformAttr = CSSPlugin.useSVGTransformAttr || _forceSVGTransformAttr), m = _getMatrix(t), m !== _identity2DMatrix) {
                            if (16 === m.length) {
        ...
        if (!_globals.TweenLite) {
                    ...
                    this.check = function(init) {
                        ...
                        if (0 === missing && func) {
                            if (a = ("com.greensock." + ns).split("."), n = a.pop(), cl = _namespace(a.join("."))[n] = this.gsClass = func.apply(func, _classes), global)
                                if (_globals[n] = _exports[n] = cl, hasModule = "undefined" != typeof module && module.exports, !hasModule && "function" == typeof define && define.amd) define((window.GreenSockAMDPath ? window.GreenSockAMDPath + "/" : "") + ns.split(".").pop(), [], function() {
                                    return cl
                                });
                                else if (hasModule)
                                if (ns === moduleName) {
            ...
            var _lazyTweens = [],
                ...
                _setRatio = function(v) {
                    for (var val, pt = this._firstPT, min = 1e-6; pt;) val = pt.blob ? v ? this.join("") : this.start : pt.c * v + pt.s, pt.m ? val = pt.m(val, this._target || pt.t) : val < min && val > -min && (val = 0), pt.f ? pt.fp ? pt.t[pt.p](pt.fp, val) : pt.t[pt.p](val) : pt.t[pt.p] = val, pt = pt._next
                },
                _blobDif = function(start, end, filter, pt) {
                    ...
                    return s += end.substr(charIndex),
                        s && a.push(s), a.setRatio = _setRatio, a
                },
            ...
            p._init = function() {
                ...
                if (v.startAt) {
                    ...
                    if (startVars.overwrite = !1, startVars.immediateRender = !0, startVars.lazy = immediate && v.lazy !== !1, startVars.startAt = startVars.delay = null, this._startAt = TweenLite.to(this.target, 0, startVars), immediate)
                ...
                else if (time < 1e-7) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== prevTime || 0 === duration && prevRawPrevTime > 0) && (callback = "onReverseComplete", isComplete = this._reversed), time < 0 && (this._active = !1, 0 === duration && (this._initted || !this.vars.lazy || force) && (prevRawPrevTime >= 0 && (prevRawPrevTime !== _tinyNum || "isPause" !== this.data) && (force = !0), this._rawPrevTime = rawPrevTime = !suppressEvents || time || prevRawPrevTime === time ? time : _tinyNum)), this._initted || (force = !0);
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        Plugin.prototype.transformSupport = function(value) {
            ...
            if (!jsProperty)
                for (var i = 0, l = this.vendors.length; i < l; i++)
                    if (jsProperty = null !== this.vendors[i] ? $.camelCase(this.vendors[i][1] + "-" + property) : property, element.style[jsProperty] !== undefined) {
            ...
            if (!this.desktop && null !== event.beta && null !== event.gamma) {
                ...
                this.portrait !== portrait && (this.portrait = portrait, this.calibrationFlag = !0),
                    this.calibrationFlag && (this.calibrationFlag = !1, this.cx = x, this.cy = y), this.ix = x, this.iy = y
            }
    ...
    function(global, factory) {
        ...
        }) : "undefined" != typeof exports ? module.exports = factory(require("jquery"), global, global.document, global.Math) : factory(jQuery, global, global.document, global.Math)
        ...
        $.fn.fullpage = function(options) {
            function init() {
                options.css3 && (options.css3 = support3d()), options.scrollBar = options.scrollBar || options.hybrid, setOptionsFromDOM(), prepareDom(), FP.setAllowScrolling(!0), FP.setAutoScrolling(options.autoScrolling, "internal");
            ...
            function loadExtension(externalName) {
                ...
                FP[internalName] = "undefined" != typeof window[externalName] ? new window[externalName] : null
            }
            ...
            function prepareDom() {
                ...
                }), options.fixedElements && options.css3 && $(options.fixedElements).appendTo($body), options.navigation && addVerticalNavigation(), enableYoutubeAPI(), enableVidemoAPI(), options.scrollOverflow ? ("complete" === document.readyState && createScrollBarHandler(), $window.on("load", createScrollBarHandler)) : afterRenderActions()
            }
            ...
            function styleMenu(section, index) {
                "undefined" != typeof options.anchors[index] && section.hasClass(ACTIVE) && activateMenuAndNav(options.anchors[index], index), options.menu && options.css3 && $(options.menu).closest(WRAPPER_SEL).length && $(options.menu).appendTo($body)
            }
            ...
            function scrolling(type, scrollable) {
                if (isScrollAllowed.m[type]) {
                    var check = "down" === type ? "bottom" : "top",
                        scrollSection = "down" === type ? FP.moveSectionDown : FP.moveSectionUp;
                    if (FP.scrollHorizontally && (scrollSection = FP.scrollHorizontally.getScrollSection(type, scrollSection)), scrollable.length > 0) {
            ...
            function touchMoveHandler(event) {
                ...
                if (!checkParentForNormalScrollElement(event.target) && isReallyTouch(e)) {
                    ...
                    if (canScroll && !slideMoving) {
                        ...
                        touchEndY = touchEvents.y, touchEndX = touchEvents.x, activeSection.find(SLIDES_WRAPPER_SEL).length && Math.abs(touchStartX - touchEndX) > Math.abs(touchStartY - touchEndY) ? Math.abs(touchStartX - touchEndX) > $window.outerWidth() / 100 * options.touchSensitivity && (touchStartX > touchEndX ? isScrollAllowed.m.right && FP.moveSlideRight(activeSection) : isScrollAllowed.m.left && FP.moveSlideLeft(activeSection)) : options.autoScrolling && Math.abs(touchStartY - touchEndY) > $window.height() / 100 * options.touchSensitivity && (touchStartY > touchEndY ? scrolling("down", scrollable) : touchEndY > touchStartY && scrolling("up", scrollable))
                    }
                }
            }
            ...
            function performMovement(v) {
                if (options.css3 && options.autoScrolling && !options.scrollBar) {
                    ...
                    transformContainer(translate3d, !0), options.scrollingSpeed ? afterSectionLoadsId = setTimeout(function() {
                        afterSectionLoads(v)
            ...
            function afterSectionLoads(v) {
                continuousVerticalFixSectionOrder(v), $.isFunction(options.afterLoad) && !v.localIsResizing && options.afterLoad.call(v.element, v.anchorLink, v.sectionIndex + 1), options.scrollOverflowHandler.afterLoad(), options.resetSliders && FP.resetSliders && FP.resetSliders.apply(v), playMedia(v.element), v.element.addClass(COMPLETELY).siblings().removeClass(COMPLETELY), canScroll = !0, $.isFunction(v.callback) && v.callback.call(this)
            }
            ...
            function playMedia(destiny) {
                ...
                destiny.find("video, audio").each(function() {
                    ...
                    var element = $(this).get(0);
                    playYoutube(element), element.onload = function() {
                        playYoutube(element)
                    }
                })
            }
            ...
            function scrollToAnchor() {
                var value = window.location.hash.replace("#", "").split("/"),
                    section = decodeURIComponent(value[0]),
                    slide = decodeURIComponent(value[1]);
                section && (options.animateAnchor ? scrollPageAndSlide(section, slide) : FP.silentMoveTo(section, slide))
            }
            ...
            function hashChangeHandler() {
                if (!isScrolling && !options.lockAnchors) {
                    ...
                    section.length && (section && section !== lastScrolledDestiny && !isFirstSlideMove || isFirstScrollMove || !slideMoving && lastScrolledSlide != slide) && scrollPageAndSlide(section, slide)
                }
            }
            ...
            function slideArrowHandler() {
                ...
                $(this).hasClass(SLIDES_PREV) ? isScrollAllowed.m.left && FP.moveSlideLeft(section) : isScrollAllowed.m.right && FP.moveSlideRight(section)
            }
            ...
            function onkeydown(e) {
                ...
                switch (e.which) {
                    case 38:
                    case 33:
                        isScrollAllowed.k.up && FP.moveSectionUp();
                        break;
                    case 32:
                    ...
                    case 40:
                    case 34:
                        isScrollAllowed.k.down && FP.moveSectionDown();
                        break;
                    case 36:
                        isScrollAllowed.k.up && FP.moveTo(1);
                        break;
                    case 35:
                        isScrollAllowed.k.down && FP.moveTo($(SECTION_SEL).length);
                        break;
                    case 37:
                        isScrollAllowed.k.left && FP.moveSlideLeft();
                        break;
                    case 39:
                        isScrollAllowed.k.right && FP.moveSlideRight();
                        break;
                    default:
                        return
                }
            ...
            function mouseMoveHandler(e) {
                canScroll && (e.pageY < oldPageY && isScrollAllowed.m.up ? FP.moveSectionUp() : e.pageY > oldPageY && isScrollAllowed.m.down && FP.moveSectionDown()), oldPageY = e.pageY
            }
            ...
            function landscapeScroll(slides, destiny, direction) {
                ...
                return v.xMovement = getXmovement(v.prevSlideIndex, v.slideIndex), canScroll = !1, options.onSlideLeave && !v.localIsResizing && "none" !== v.xMovement && $.isFunction(options.onSlideLeave) && options.onSlideLeave.call(v.prevSlide, v.anchorLink, v.sectionIndex + 1, v.prevSlideIndex, v.xMovement, v.slideIndex) === !1 ? void(slideMoving = !1) : (stopMedia(v.prevSlide), destiny.addClass(ACTIVE).siblings().removeClass(ACTIVE), v.localIsResizing || lazyLoad(destiny), !options.loopHorizontal && options.controlArrows && (section.find(SLIDES_ARROW_PREV_SEL).toggle(0 !== v.slideIndex), section.find(SLIDES_ARROW_NEXT_SEL).toggle(!destiny.is(":last-child"))), section.hasClass(ACTIVE) && setState(v.slideIndex, v.slideAnchor, v.anchorLink, v.sectionIndex), FP.continuousHorizontal && FP.continuousHorizontal.apply(v), performHorizontalMove(slides, v, !0), void(options.interlockedSlides && FP.interlockedSlides && FP.interlockedSlides.apply(v)))
            }

            function afterSlideLoads(v) {
                FP.continuousHorizontal && FP.continuousHorizontal.afterSlideLoads(v), activeSlidesNavigation(v.slidesNav, v.slideIndex), v.localIsResizing || ($.isFunction(options.afterSlideLoad) && options.afterSlideLoad.call(v.destiny, v.anchorLink, v.sectionIndex + 1, v.slideAnchor, v.slideIndex), canScroll = !0), playMedia(v.destiny), slideMoving = !1, FP.interlockedSlides && FP.interlockedSlides.apply(v)
            }
            ...
            function responsive() {
                ...
                widthLimit && heightLimit ? FP.setResponsive(isBreakingPointWidth || isBreakingPointHeight) : widthLimit ? FP.setResponsive(isBreakingPointWidth) : heightLimit && FP.setResponsive(isBreakingPointHeight)
            }
            ...
            function scrollPageAndSlide(destiny, slide) {
                ...
                "undefined" == typeof slide && (slide = 0), destiny === lastScrolledDestiny || section.hasClass(ACTIVE) ? scrollSlider(section, slide) : scrollPage(section, function() {
            ...
            function silentLandscapeScroll(activeSlide, noCallbacks) {
                FP.setScrollingSpeed(0, "internal"), "undefined" != typeof noCallbacks && (isResizing = !0), landscapeScroll(activeSlide.closest(SLIDES_WRAPPER_SEL), activeSlide), "undefined" != typeof noCallbacks && (isResizing = !1), FP.setScrollingSpeed(originals.scrollingSpeed, "internal")
            }
            ...
            function setIsScrollAllowed(value, direction, type) {
                switch (direction) {
                    ...
                    case "right":
                        ...
                        break;
                    case "all":
                        "m" == type ? FP.setAllowScrolling(value) : FP.setKeyboardScrolling(value)
                }
            }
            ...
            displayWarnings(), iscrollOptions.click = isTouch, iscrollOptions = $.extend(iscrollOptions, options.scrollOverflowOptions), $.extend($.easing, {
                ...
                options.autoScrolling && !options.scrollBar ? ($htmlBody.css({
                    overflow: "hidden",
                    height: "100%"
                }), FP.setRecordHistory(originals.recordHistory, "internal"), container.css({
                ...
                FP.setScrollingSpeed(0, "internal"), FP.moveTo(sectionAnchor, slideAnchor), FP.setScrollingSpeed(originals.scrollingSpeed, "internal")
                ...
                if (!container.hasClass(DESTROYED)) {
                    ...
                    sectionIndex && FP.silentMoveTo(sectionIndex + 1), isResizing = !1, $.isFunction(options.afterResize) && resizing && options.afterResize.call(container), $.isFunction(options.afterReBuild) && !resizing && options.afterReBuild.call(container)
                }
            }, FP.setResponsive = function(active) {
                var isResponsive = $body.hasClass(RESPONSIVE);
                active ? isResponsive || (FP.setAutoScrolling(!1, "internal"), FP.setFitToSection(!1, "internal"), $(SECTION_NAV_SEL).hide(), $body.addClass(RESPONSIVE)) : isResponsive && (FP.setAutoScrolling(originals.autoScrolling, "internal"), FP.setFitToSection(originals.autoScrolling, "internal"), $(SECTION_NAV_SEL).show(), $body.removeClass(RESPONSIVE))
            ...
            }, $(this).length && (loadExtension("fp_continuousHorizontalExtension"), loadExtension("fp_scrollHorizontallyExtension"), loadExtension("fp_resetSlidersExtension"), loadExtension("fp_interlockedSlidesExtension"), init(), bindEvents());
            var isScrolling = !1,
                lastScroll = 0,
                touchStartY = 0,
                touchStartX = 0,
        ...
        var iscrollHandler = {
            ...
            onLeave: function() {
                ...
                "undefined" != typeof scroller && scroller && scroller.wheelOff()
            },
            afterLoad: function() {
                var scroller = $(SECTION_ACTIVE_SEL).find(SCROLLABLE_SEL).data("iscrollInstance");
                "undefined" != typeof scroller && scroller && scroller.wheelOn()
            },
            create: function(element, scrollHeight) {
                ...
                scrollable.height(scrollHeight), scrollable.each(function() {
                    ...
                    iScrollInstance && $.each(iscrollHandler.iScrollInstances, function() {
                        $(this).destroy()
                    }), iScrollInstance = new IScroll($this.get(0), iscrollOptions), iscrollHandler.iScrollInstances.push(iScrollInstance), $this.data("iscrollInstance", iScrollInstance)
                })
            },
        ...
        var t = g.requestAnimationFrame || g.webkitRequestAnimationFrame || g.mozRequestAnimationFrame || g.oRequestAnimationFrame || g.msRequestAnimationFrame || function(a) {
            ...
            d = function() {
                ...
                var b = {},
                    ...
                    e = function() {
                        for (var b, a = ["t", "webkitT", "MozT", "msT", "OT"], e = 0, d = a.length; e < d; e++)
        ...
        Util = function() {
            ...
            return WeakMap.prototype.get = function(key) {
                ...
                for (ref = this.keys, i = j = 0, len = ref.length; j < len; i = ++j)
                    if (item = ref[i], item === key) return this.values[i]
            }, WeakMap.prototype.set = function(key, value) {
                var i, item, j, len, ref;
                for (ref = this.keys, i = j = 0, len = ref.length; j < len; i = ++j)
                    if (item = ref[i], item === key) return void(this.values[i] = value);
            ...
            return WOW.prototype.defaults = {
                ...
                if (this.scrolled && (this.scrolled = !1, this.boxes = function() {
                        var j, len, ref, results;
                        for (ref = this.boxes, results = [], j = 0, len = ref.length; j < len; j++) box = ref[j], box && (this.isVisible(box) ? this.show(box) : results.push(box));
                        return results
    ...
    function(root, factory) {
                ...
                if (fs.spec) {
                    ...
                    fs.api = {
                        ...
                        fullscreenElement: function(elem) {
                            return elem = elem ? elem : d, elem[s[1]]
                        },
                        requestFullscreen: function(elem) {
                            return elem[s[2]]()
                        },
                        exitFullscreen: function(elem) {
                            return elem = elem ? elem : d, elem[s[3]]()
                        }
                    }, fs.event = {
        ...
        $.jPlayer.keys = function(en) {
            ...
            $(document.documentElement).unbind(event), en && $(document.documentElement).bind(event, keyBindings)
            ...
            _testPlaybackRate: function(type) {
                ...
                try {
                    return "playbackRate" in el && (el.playbackRate = rate, el.playbackRate === rate)
                } catch (err) {
                    return !1
                }
            },
            ...
            _updateInterface: function() {
                ...
                var currentTimeText = "";
                this.css.jq.currentTime.length && (currentTimeText = this._convertTime(this.status.currentTime), currentTimeText !== this.css.jq.currentTime.text() && this.css.jq.currentTime.text(this._convertTime(this.status.currentTime)));
                var durationText = "",
            ...
            play: function(time) {
                ...
                guiAction && this.options.useStateClassSkin && !this.status.paused ? this.pause(time) : (time = "number" == typeof time ? time : NaN, this.status.srcSet ? (this.focus(), this.html.active ? this._html_play(time) : this.aurora.active ? this._aurora_play(time) : this.flash.active && this._flash_play(time)) : this._urlNotSetError("play"))
            },
            videoPlay: function() {
                this.play()
            },
            ...
            mute: function(mute) {
                ...
                guiAction && this.options.useStateClassSkin && this.options.muted ? this._muted(!1) : (mute = mute === undefined || !!mute, this._muted(mute))
            },
            ...
            _cssSelector: function(fn, cssSel) {
                ...
                if ("string" == typeof cssSel)
                    if ($.jPlayer.prototype.options.cssSelector[fn]) {
                        if (this.css.jq[fn] && this.css.jq[fn].length && this.css.jq[fn].unbind(".jPlayer"), this.options.cssSelector[fn] = cssSel, this.css.cs[fn] = this.options.cssSelectorAncestor + " " + cssSel, cssSel ? this.css.jq[fn] = $(this.css.cs[fn]) : this.css.jq[fn] = [], this.css.jq[fn].length && this[fn]) {
            ...
            _updateAutohide: function() {
                var self = this,
                    ...
                    handler = function(event) {
                        ...
                        "undefined" != typeof self.internal.mouse ? (deltaX = self.internal.mouse.x - event.pageX, deltaY = self.internal.mouse.y - event.pageY, moved = Math.floor(deltaX) > 0 || Math.floor(deltaY) > 0) : moved = !0, self.internal.mouse = {
                            x: event.pageX,
                            y: event.pageY
            ...
            _html_initMedia: function(media) {
                ...
                $.each(media.track || [], function(i, v) {
                    ...
                    track.setAttribute("kind", v.kind ? v.kind : ""), track.setAttribute("src", v.src ? v.src : ""),
                        track.setAttribute("srclang", v.srclang ? v.srclang : ""), track.setAttribute("label", v.label ? v.label : ""), v.def && track.setAttribute("default", v.def), $media.append(track)
            ...
            _getFlashPluginVersion: function() {
                ...
                } catch (e) {} else navigator.plugins && navigator.mimeTypes.length > 0 && (flash = navigator.plugins["Shockwave Flash"], flash && (version = navigator.plugins["Shockwave Flash"].description.replace(/.*\s(\d+\.\d+).*/, "$1")));
                return 1 * version
            },
