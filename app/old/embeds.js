/*1487167839,,JIT Construction: v2835688,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d('ig.sdk.Embeds', ['CSS', 'DOMEventListener', 'sdk.domReady', 'IGIframeableMessageTypes', 'invariant', 'isNumberLike'], function a(b, c, d, e, f, g, h, i, j, k, l, m) {
                    var n = h.addClass,
                        o = h.removeClass,
                        p = ['instagram\\.com', 'instagr\\.am'],
                        q = 'data-instgrm-captioned',
                        r = 'instagram-embed-',
                        s = 10000,
                        ...
                        z = y + '-registered',
                        aa = y + '-rendered',
                        ba = new RegExp('^' + 'https?://' + '([\\w-]+\\.)*(' + p.join('|') + ')' + '$'),
                        ca = 'data-instgrm-payload-id',
                        da = 'instagram-media-payload-',
                        ea = new RegExp('^(' + ba.source.replace(/^\^/, '').replace(/\$$/, '') + '/p/[^/]+' + ')'),
                        fa = 'data-instgrm-preserve-position',
                        ga = 'data-instgrm-version',
                        ha = {},
                        ia = false,
                        ja = {},
                        ka = 0,
                    ...
                    function na(wa) {
                        var xa = document.getElementsByTagName('iframe'),
                            ya;
                    ...
                    function pa(wa) {
                        var xa = wa.getElementsByTagName('a'),
                            ya = xa.length;
                    ...
                    function ua() {
                        var wa = document.getElementsByClassName(y),
                            xa;
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2835688","namespace":"instgrm","message":"' + e.message + '"}}');
}
